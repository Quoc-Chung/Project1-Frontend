...
export interface ChartTooltipContentProps
  ...
  labelFormatter?: (value: string | number | null, payload?: TooltipPayloadItem[]) => React.ReactNode
...
export function ChartTooltipContent({
  ...
  // Hook luôn được gọi, kiểm tra điều kiện bên trong
  const tooltipLabel = useMemo(() => {
    if (!active || hideLabel || payload.length === 0) return null
  ...
  }, [active, hideLabel, payload, label, labelFormatter, labelClassName, config, labelKey])
...
// Helper
function getPayloadConfigFromPayload(config: ChartConfig, payload: TooltipPayloadItem, key: string) {
